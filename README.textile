...
A "Mavenization":http://maven.apache.org of the "Red5 Flash Server":http://osflash.org/red5 version 0.8rc1. Parts of Red5 have been separated into logical modules, which use Maven to manage dependencies:
